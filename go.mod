module github.com/ardanlabs/practical-ai-gcuk-2026

go 1.26.4

require (
	github.com/ardanlabs/ai-training v0.0.0-20260811045959-bf0a96745684
...
require (
	...
	github.com/hybridgroup/yzma v1.22.0 // indirect
